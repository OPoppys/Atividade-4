...
public class Main {
        public static void main(String[] args) {
            ...
            for(int i = 0; i < numvet; i++){// Esse for preenche os valores dentro do vetor// Esse for mostra os valores do vetor para o usuario//Esse for soma o valor de dentro do vetor e o sout mostra para o user
            ...
            for(int i = 0; i < numvet; i++){//No primeiro if tiramos o maior valor do vetor//No segundo if tiramos o menor valor do vetor
                if(vetmaior < vetor[i]) {
                    vetmaior = vetor[i];
                }
                if (vetmenor > vetor[i]) {
            ...
            for(int i = 0; i < numvet; i++) {// Esse for mostra os valores do vetor para o usuario//Esse for soma o valor de dentro do vetor e depois mostra para o user novamente
                System.out.println("O espaço do vetor numero " + i + " tem o valor de " + vetor[i]);
